...
<div class="px-6 py-6">
    <!-- Judul Halaman -->
    <h1 class="text-2xl font-semibold text-gray-800 mb-4">Edit Departemen</h1>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form action="{{ route('departments.update', $department->uuid) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="department"
                        ...
                        placeholder="Masukkan Nama Departemen" value="{{ old('department', $department->department) }}">
                    @error('department')
                ...
                <div>
                    ...
                    <input type="text" name="abbrivation"
                        ...
                        placeholder="Masukkan Singkatan Departemen"
                        value="{{ old('abbrivation', $department->abbrivation) }}">
                    @error('abbrivation')
                    <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
