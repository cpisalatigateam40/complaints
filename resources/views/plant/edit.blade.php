...
@section('content')
<!-- Page Heading -->
<h1 class="text-2xl font-semibold text-gray-800 mb-4">Edit Plant</h1>
...
<div class="bg-white shadow rounded-lg p-6">
    <form method="POST" action="{{ route('plants.update', $plant->uuid) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block font-medium text-gray-700 mb-1">
                    Nama Plant <span class="text-red-500">*</span>
                </label>
                <input type="text" name="plant" placeholder="Masukkan Nama Plant"
            ...
            <div>
                ...
                <input type="text" name="abbrivation" placeholder="Masukkan Singkatan Plant"
                    value="{{ old('abbrivation', $plant->abbrivation) }}"
